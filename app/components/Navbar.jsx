...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`navbar w-full bg-white dark:bg-theme z-10 flex items-center justify-between px-10 py-3.5 ${sticky ? "fixed top-0 shadow-[0_0_10px_0_rgba(0,0,0,.8)]" : ""
          }`}
      >
        ...
        <div
          className={`menu-icon cursor-pointer select-none absolute right-7 md:hidden ${sticky ? "z-20" : "z-50"
            }`}
          onClick={toggleOpen}
        >
          <motion.span
